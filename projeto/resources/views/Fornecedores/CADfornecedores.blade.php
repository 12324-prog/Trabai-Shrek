...
<body>
    ...
    <main class="container">
        <section class="hero">
            ...
            <div class="card">
                <form action="{{ $fornecedor ? route('fornecedores.update', ['id' => $fornecedor->cod_fornecedor]) : route('fornecedores.store') }}" method="POST" class="form-qa">
                    @csrf
                    <div class="question">
                        <div class="q-bubble">Nome Social</div>
                        <div class="answer"><input type="text" id="nomeS" name="nomeS" value="{{$fornecedor->nome_social ?? ''}}" required></div>
                    </div>
                   
                    <div class="question">
                        <div class="q-bubble">Celular</div>
                        <div class="answer"><input type="tel" id="Celular" name="Celular" value="{{$fornecedor->celular ?? ''}}" required></div>
                    </div>

                    <button type="submit" class="btn btn--shrek slime-drop">{{ $fornecedor ? 'Atualizar' : 'Cadastrar' }}</button>
                </form>
            </div>
        </section>
    </main>
    ...
    <footer class="footer">
        ...
        <div class="btn-group">
            ...
            <a href="{{ route('fornecedores.index') }}" class="btn btn--slime">Ver Fornecedores</a>
        </div>
    </footer>
