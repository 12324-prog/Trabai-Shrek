    ...
    <main class="container">
        <section class="hero">
                ...
                <table class="shrek-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="acoes">
                                <a href="{{ route('clientes.edit', ['id'=>$cliente->cod_cliente]) }}" class="btn btn--ghost">Editar</a>
                                <form action="{{ route('clientes.destroy', ['id'=>$cliente->cod_cliente]) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="btn-group" style="margin-top: 20px;">
                <a href="{{ route('clientes.cadastrar') }}" class="btn btn--shrek slime-drop">+ Novo Cliente</a>
            </div>
        </section>
    </main>
